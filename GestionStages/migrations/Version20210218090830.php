 ...
 */
final class Version20210218090830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Stage (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, poste VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, actif TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, date_expiration DATETIME DEFAULT NULL, date_modification DATETIME DEFAULT NULL, email VARCHAR(255) NOT NULL, societe VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_3BDBC6DBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
